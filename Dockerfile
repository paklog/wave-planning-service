# ============================================
# Multi-stage Dockerfile for Wave Planning Service
...
LABEL org.opencontainers.image.title="Wave Planning Service" \
      org.opencontainers.image.description="Multi-strategy wave optimization service" \
